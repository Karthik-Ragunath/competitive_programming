...
class MaxSubarray
{
    ...
    public static void main(String[] args)
    {
        ...
        for(int l = 0; l < testcases; l++)
        {
            ...
            {
                terms[i] = in.nextInt();
                prefixSumArray[i] = prefixSumArray[i - 1] + terms[i];
            }
            ...
            for(int i = 1; i <= numberOfTerms; i++)
            {
                ...
                {
                    System.out.println("Index " + j + " : " + globalMax[j] + " " + currentMax[j]);
                }
                System.out.println("Global max position: " + globalMaxIndexPosition);
