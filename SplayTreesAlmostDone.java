...
class SplayTreesAlmostDone
{
    ...
    {
        System.out.println("Root's key: " + root.key + " value: " + value);
        if (root.left != null)
        {
        ...
        {
            System.out.println("The root's right is: " + root.right.value);
    ...
    public static Node splay(Node root, int keyToBeSplayed, Node nodeToBeSplayed)
    {
        ...
        {
            // System.out.println("The comparisons: keyToBeSplayed: " + keyToBeSplayed + " root: " + root.key);
        ...
        // System.out.println("The node to be splayed value is: " + nodeToBeSplayed.value);
        return root;
    }
    ...
    public static void main(String[] args)
    {
        ...
        // System.out.println();
        // System.out.println("The initial key-value pairs of given value in the BST is:");
        // valueMaintainer.value = 1;
        // keyAndValuePrinter(root, valueMaintainer);
        ...
        for(int i = 0; i < numberOfQueries; i++)
        {
            ...
            */
            ...
            {
                System.out.println("Before Left Split: " + root.value);
            }
            Node[] leftAndRightParts = leftSplit(root);
            Node leftPart = leftAndRightParts[0];
            root = leftAndRightParts[1];
            /*
            System.out.println("The left and right parts value are: Left Part -> " + leftPart.value + " Right Part -> " + root.value);
            if (root.left == null)
            {
                System.out.println("The root.left value is null");
            }
            */
            System.out.println();
            System.out.println("Before right split: " + root.key);
            ...
            if (i == numberOfQueries - 1)
            {
                System.out.println("The old root value is: " + oldRoot.value + " old root.right -> " + oldRoot.right.value);
            }
            root = rightEndSplit[1];
            /*
            System.out.println("The old and new roots value are: Old Root -> " + oldRoot.value + " New Root -> " + root.value);
            valueMaintainer.value = 1;
            keyAndValuePrinter(oldRoot, valueMaintainer);
            */
            if (leftPart != null)
            {
            ...
            {
                System.out.println("The left part is null");
            }
