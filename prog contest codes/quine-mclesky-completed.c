...
int main(void) {
    ...
    printf("the code is in this line\n");
    for(i=0;i<d1;i++)
    {
        for(m=0;m<noofvariables;m++)
        {
    ...
    z=i;
    printf("the code is in this checkpoint\n");
    for(i=0;i<z;i++)
    {
        for(m=0;m<noofvariables;m++)
        {
    ...
    printf("checkpoint3\n");
    printf("the prime impicants are :\n");
    for(i=0;i<j2;i++)
    {
        for(m=0;m<noofvariables;m++)
        {
