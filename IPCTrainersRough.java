...
class IPCTrainersRough
{
    ...
    public static void computeOnHeapifiedList(ArrayList<Integer> heapifiedList, int[] lecturesToBeTaken, int[] sadnessCount)
    {
        if(heapifiedList.size() != 1)
        {
            ...
            System.out.println("Response -> index: " + heapHead + " lecturesLeft: " + lecturesLeft);
            if(lecturesLeft == 1)
            {
            ...
            {
                System.out.println("HeadIndex : " + heapHead);
