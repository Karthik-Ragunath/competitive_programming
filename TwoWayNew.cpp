...
ll returnLargestArea()
{
    for(ll i = 0; i < islandNumber; i++)
    {
        ...
        unordered_map< ll, pair< ll, set< ll > > > islandValueSizePair;
            ...
            else
            {
                if(!visitedIsland[childIslandIndex])
                {
                    ...
                    if(previousIslandValuesIter == previousIslandValues.end())
                    {
                        ...
                        unordered_map< ll, pair< ll, set< ll > > >::iterator unorderedIter = islandValueSizePair.find(childIslandValue);
                        if(unorderedIter != islandValueSizePair.end())
                        {
                            set< ll > correspondingChildSet = unorderedIter -> second.second;
                            set< ll >::iterator corresChildIter = correspondingChildSet.begin();
                            ...
                            if(!alreadyVisited)
                            {
                                ...
                                correspondingChildSet.insert(childIslandIndex);
                        ...
                        {
                            set< ll > newSet;
                            newSet.insert(childIslandIndex);
        ...
        unordered_map< ll, pair< ll, set< ll > > >::iterator unorderedIter = islandValueSizePair.begin();
