        ...
        else
        {
            ...
            if(solutionExists)
            {
                if(allUnidentified)
                {
                    ...
                    numberOfSolutions = (numberOfSolutions * (k - numberOfTerms)) % modValue;
                    // cout << "Increasing Solutions: " << numberOfSolutions << endl;
                }
                else
                {
                    numberOfSolutions = (numberOfSolutions * 1) % modValue;
                }
            }
            else
            {
...
int main()
{
    ...
    for(ll m = 0; m < testcases; m++)
    {
        ...
        if(valid)
        {
            ...
            if(solution.first)
            {
                numberOfSolutions = (numberOfSolutions * solution.second) % modValue;
                    ...
                    for(; iterIncDec != increasingDecreasingMerge.end(); iterIncDec++)
                    {
                        ...
                        if(incRange >= decRange)
                        {
                            ...
                            if(solution.first)
                            {
                                ...
                                numberOfSolutions = (numberOfSolutions * localNumberOfSolutions) % modValue;
                            }
                            else
                            {
                                break;
            ...
            if(solution.first)
            {
                for(ll i = 0; i < size; i++)
                {
                    if(elements[i] == -1)
                    {
                        if(!visited[i])
                        {
                            numberOfSolutions = (numberOfSolutions * k) % modValue;
                        }
                    }
                }
