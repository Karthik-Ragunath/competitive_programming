...
int main()
{
    ...
    struct binarytreenode *temp=NULL;
        struct binarytreenode *printcheck=NULL;
    ...
    scanf("%d",&element);
        printcheck=(struct binarytreenode*)malloc(sizeof(struct binarytreenode));
    ...
    else
    {
        ...
        {
            printf("%d",printcheck->data);
            printcheck=printcheck->rightnext;
        }
    return 0;
}