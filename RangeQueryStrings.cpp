...
int main()
{
    ...
    for(ll n = 0; n < testcases; n++)
    {
        ...
        for(ll j = 0; j < length; j++)
        {
            ...
            {
                ll contributionVal = contributionTableCumulative[indexValue][j] - contributionTableCumulative[i][j];
            ...
            {
                ll contributionVal = contributionTableCumulative[length - 1][j] - contributionTableCumulative[i][j];
