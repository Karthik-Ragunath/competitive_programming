...
class SegmentTreesRefined
{
    ...
    public static void main(String[] args)
    {
        ...
        Node root = buildMaxSegmentTrees(terms, left, right);
        int numberOfQueries = in.nextInt();
        for(int i = 0; i < numberOfQueries; i++)
        {
            int leftMin = in.nextInt();
            int rightMax = in.nextInt();
            int answer = buildRangeMaximumQuery(root, left, right, leftMin - 1, rightMax - 1);
